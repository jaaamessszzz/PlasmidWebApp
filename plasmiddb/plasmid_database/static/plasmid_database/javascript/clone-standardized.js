...
function initializeTable(assemblyType){
    ...
    let aliasCell = document.createElement('th');
    aliasCell.innerText = 'Alias';
    newHeader.appendChild(aliasCell);
    // New default row
    ...
    let aliasInput = document.createElement('td');
    aliasInput.innerHTML = '<input class="assemblyAlias" type="text"/>';
    aliasInput.className = 'Alias';
    newDefault.appendChild(aliasInput);
